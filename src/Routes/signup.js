        ...
        <section className="signup-container">
            ...
            <form className="signup-form" onSubmit={handleSubmit}>
                <article className="input-container">
                    ...
                    <br/>
                    <input name="nickname" className="signup-input" onChange={handleSignIn}/>
                    <br/>
                </article>
                <article className="input-container">
                    <label htmlFor="fullName">Full Name:</label>
                    <br/>
                    <input name="fullName" className="signup-input" onChange={handleSignIn}/>
                    <br/>
                </article>
                <article className="input-container">
                    <label htmlFor="password">Password:</label>
                    <br/>
                    <input name="password" className="signup-input" onChange={handleSignIn}/>
                    <br/>
                </article>
                <article className="radio-container">
                    <label htmlFor="businessType">I prefer to be a:</label>
                    <br/>
                    <input type="radio" className="radio-input" name="profile" value="Freelancer" checked={businessType === 'Freelancer'} onClick={handleBusinessType} onChange={handleSignIn} />
                    <label htmlFor="Freelancer">Freelancer</label>
                    <br/>
                    <input type="radio" className="radio-input" name ="profile" value="Business" checked={businessType === 'Business'} onClick={handleBusinessType} onChange={handleSignIn} />
